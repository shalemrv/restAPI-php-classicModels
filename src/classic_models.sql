...
(10383,'2020-02-22','2020-03-02','2020-02-25','Shipped',NULL,141),

(10384,'2020-02-23','2020-03-06','2020-02-27','Shipped',NULL,321),

(10385,'2020-02-28','2020-03-09','2020-03-01','Shipped',NULL,124),

(10386,'2020-03-01','2020-03-09','2020-03-06','Resolved','Disputed then Resolved on 3/15/2005. Customer doesn\'t like the craftsmaship of the models.',141),

(10387,'2020-03-02','2020-03-09','2020-03-06','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',148),

(10388,'2020-03-03','2020-03-11','2020-03-09','Shipped',NULL,462),

(10389,'2020-03-03','2020-03-09','2020-03-08','Shipped',NULL,448),

(10390,'2020-03-04','2020-03-11','2020-03-07','Shipped','They want to reevaluate their terms agreement with Finance.',124),

(10391,'2020-03-09','2020-03-20','2020-03-15','Shipped',NULL,276),

(10392,'2020-03-10','2020-03-18','2020-03-12','Shipped',NULL,452),

(10393,'2020-03-11','2020-03-22','2020-03-14','Shipped','They want to reevaluate their terms agreement with Finance.',323),

(10394,'2020-03-15','2020-03-25','2020-03-19','Shipped',NULL,141),

(10395,'2020-03-17','2020-03-24','2020-03-23','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',250),

(10396,'2020-03-23','2020-04-02','2020-03-28','Shipped',NULL,124),

(10397,'2020-03-28','2020-04-09','2020-04-01','Shipped',NULL,242),

(10398,'2020-03-30','2020-04-09','2020-03-31','Shipped',NULL,353),

(10399,'2020-04-01','2020-04-12','2020-04-03','Shipped',NULL,496),

(10400,'2020-04-01','2020-04-11','2020-04-04','Shipped','Customer requested that DHL is used for this shipping',450),

(10401,'2020-04-03','2020-04-14',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',328),

(10402,'2020-04-07','2020-04-14','2020-04-12','Shipped',NULL,406),

(10403,'2020-04-08','2020-04-18','2020-04-11','Shipped',NULL,201),

(10404,'2020-04-08','2020-04-14','2020-04-11','Shipped',NULL,323),

(10405,'2020-04-14','2020-04-24','2020-04-20','Shipped',NULL,209),

(10406,'2020-04-15','2020-04-25','2020-04-21','Disputed','Customer claims container with shipment was damaged during shipping and some items were missing. I am talking to FedEx about this.',145),

(10407,'2020-04-22','2020-05-04',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',450),

(10408,'2020-04-22','2020-04-29','2020-04-27','Shipped',NULL,398),

(10409,'2020-04-23','2020-05-05','2020-04-24','Shipped',NULL,166),

(10410,'2020-04-29','2020-05-10','2020-04-30','Shipped',NULL,357),

(10411,'2020-05-01','2020-05-08','2020-05-06','Shipped',NULL,233),

(10412,'2020-05-03','2020-05-13','2020-05-05','Shipped',NULL,141),

(10413,'2020-05-05','2020-05-14','2020-05-09','Shipped','Customer requested that DHL is used for this shipping',175),

(10414,'2020-05-06','2020-05-13',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',362),

(10415,'2020-05-09','2020-05-20','2020-05-12','Disputed','Customer claims the scales of the models don\'t match what was discussed. I keep all the paperwork though to prove otherwise',471),

(10416,'2020-05-10','2020-05-16','2020-05-14','Shipped',NULL,386),

(10417,'2020-05-13','2020-05-19','2020-05-19','Disputed','Customer doesn\'t like the colors and precision of the models.',141),

(10418,'2020-05-16','2020-05-24','2020-05-20','Shipped',NULL,412),

(10419,'2020-05-17','2020-05-28','2020-05-19','Shipped',NULL,382),

(10420,'2020-05-29','2020-06-07',NULL,'In Process',NULL,282),

(10421,'2020-05-29','2020-06-06',NULL,'In Process','Custom shipping instructions were sent to warehouse',124),

(10422,'2020-05-30','2020-06-11',NULL,'In Process',NULL,157),

(10423,'2020-05-30','2020-06-05',NULL,'In Process',NULL,314),

(10424,'2020-05-31','2020-06-08',NULL,'In Process',NULL,141),

(10425,'2020-05-31','2020-06-07',NULL,'In Process',NULL,119);
...
(124,'AE215433','2020-03-05','101244.59'),

(124,'BG255406','2019-08-28','85410.87'),

(124,'CQ287967','2018-04-11','11044.30'),

(124,'ET64396','2020-04-16','83598.04'),
...
(141,'DL460618','2020-05-19','46895.48'),

(141,'HJ32686','2019-01-30','59830.55'),

(141,'ID10962','2019-12-31','116208.40'),

(141,'IN446258','2020-03-25','65071.26'),

(141,'JE105477','2020-03-18','120166.58'),
...
(148,'ME497970','2020-03-27','3516.04'),
...
(175,'CITI3434344','2020-05-19','28500.78'),
...
(186,'AE192287','2020-03-10','23602.90'),
...
(209,'BOAF82044','2020-05-03','35157.75'),
...
(219,'BN17870','2020-03-02','3452.75'),
...
(233,'BOFA23232','2020-05-20','29070.38'),
...
(242,'HR224331','2020-06-03','12432.32'),
...
(250,'EQ12267','2020-05-17','17928.09'),
...
(276,'OJ819725','2020-04-30','29848.52'),
...
(321,'LA556321','2020-03-15','46781.66'),

(323,'AL493079','2020-05-23','75020.13'),
...
(333,'NF959653','2020-03-01','21432.31'),
...
(353,'HJ618252','2020-06-09','46656.94'),
...
(398,'JPMR4544','2020-05-18','615.45'),

(398,'KB54275','2019-11-29','48927.64'),

(406,'BJMPR4545','2020-04-23','12190.85'),
...
(448,'FS299615','2020-04-18','27966.54'),
...
(452,'HG635467','2020-05-03','8807.12'),
...
(462,'ED203908','2020-04-15','30293.77'),
...
(496,'EU531600','2020-05-25','30253.75'),
